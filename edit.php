  ...
  <div class="container">
    ...
    <form id="create-form" action="<?= $BASE_URL ?>config/process.php" method="POST">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="name" name="name" placeholder="Digite o serviço" value="<?= $contact['name'] ?>" required>
      </div>
      <div class="form-group">
        <label for="phone">Valor:</label>
        <input type="text" class="form-control" id="phone" name="phone" placeholder="Digite o valor" value="<?= $contact['phone'] ?>" required>
      </div>
      <div class="form-group">
